...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:3,spmd:0,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:True,rprd:True,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:2,rntp:3,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:8433,x:35700,y:32885,varname:node_8433,prsc:2|diff-6416-RGB,diffpow-6416-RGB,spec-7470-RGB,gloss-5953-OUT,normal-555-RGB,emission-6802-OUT,transm-7194-OUT,clip-6416-A,voffset-3097-OUT;n:type:ShaderForge.SFN_Tex2d,id:6416,x:32659,y:32567,ptovrint:False,ptlb:Albedo_Mask(A),ptin:_Albedo_MaskA,varname:node_4147,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-3232-OUT;n:type:ShaderForge.SFN_Tex2d,id:5652,x:32517,y:32888,ptovrint:False,ptlb:Transmission_Map,ptin:_Transmission_Map,varname:node_9614,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:False|UVIN-3232-OUT;n:type:ShaderForge.SFN_Tex2d,id:555,x:32660,y:33163,ptovrint:False,ptlb:NormalMap,ptin:_NormalMap,varname:node_2858,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:True|UVIN-3232-OUT;n:type:ShaderForge.SFN_Color,id:7470,x:32785,y:32723,ptovrint:False,ptlb:Spec_color,ptin:_Spec_color,varname:node_7470,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_ValueProperty,id:5953,x:32785,y:32889,ptovrint:False,ptlb:Gloss,ptin:_Gloss,varname:node_5953,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0;n:type:ShaderForge.SFN_SwitchProperty,id:9352,x:31786,y:33015,ptovrint:False,ptlb:SwitchRow,ptin:_SwitchRow,varname:node_9352,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False|A-2604-OUT,B-9446-OUT;n:type:ShaderForge.SFN_SwitchProperty,id:3739,x:31844,y:33191,ptovrint:False,ptlb:SwitchColumn,ptin:_SwitchColumn,varname:node_3739,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False|A-2604-OUT,B-9446-OUT;n:type:ShaderForge.SFN_Vector1,id:2604,x:31438,y:33054,varname:node_2604,prsc:2,v1:0;n:type:ShaderForge.SFN_Vector1,id:9446,x:31450,y:33171,varname:node_9446,prsc:2,v1:0.5;n:type:ShaderForge.SFN_TexCoord,id:2256,x:31846,y:32767,varname:node_2256,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Add,id:7663,x:32082,y:32790,varname:node_7663,prsc:2|A-2256-U,B-9352-OUT,C-7840-R;n:type:ShaderForge.SFN_Add,id:4286,x:32102,y:32980,varname:node_4286,prsc:2|A-2256-V,B-3739-OUT,C-7840-G;n:type:ShaderForge.SFN_Append,id:3232,x:32278,y:32843,varname:node_3232,prsc:2|A-7663-OUT,B-4286-OUT;n:type:ShaderForge.SFN_SwitchProperty,id:7726,x:31967,y:32533,ptovrint:False,ptlb:WorldSpaceOffset,ptin:_WorldSpaceOffset,varname:node_7726,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:True|A-6608-OUT,B-778-OUT;n:type:ShaderForge.SFN_Vector1,id:6608,x:31700,y:32411,varname:node_6608,prsc:2,v1:0;n:type:ShaderForge.SFN_If,id:9117,x:31523,y:32646,varname:node_9117,prsc:2|A-2610-OUT,B-7274-OUT,GT-3584-OUT,EQ-7274-OUT,LT-7274-OUT;n:type:ShaderForge.SFN_Vector1,id:7274,x:31221,y:32663,varname:node_7274,prsc:2,v1:0.5;n:type:ShaderForge.SFN_Vector1,id:3584,x:31221,y:32775,varname:node_3584,prsc:2,v1:1;n:type:ShaderForge.SFN_If,id:3006,x:31498,y:32457,varname:node_3006,prsc:2|A-8020-OUT,B-7274-OUT,GT-3584-OUT,EQ-7274-OUT,LT-7274-OUT;n:type:ShaderForge.SFN_Frac,id:8020,x:31221,y:32390,varname:node_8020,prsc:2|IN-6460-X;n:type:ShaderForge.SFN_Frac,id:2610,x:31221,y:32537,varname:node_2610,prsc:2|IN-6460-Z;n:type:ShaderForge.SFN_ComponentMask,id:7840,x:32209,y:32513,varname:node_7840,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-7726-OUT;n:type:ShaderForge.SFN_Append,id:778,x:31731,y:32533,varname:node_778,prsc:2|A-3006-OUT,B-9117-OUT;n:type:ShaderForge.SFN_ObjectPosition,id:6460,x:30888,y:32545,varname:node_6460,prsc:2;n:type:ShaderForge.SFN_ValueProperty,id:2025,x:33614,y:33024,ptovrint:False,ptlb:TransmissionBoost,ptin:_TransmissionBoost,varname:node_2025,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:2.8;n:type:ShaderForge.SFN_Add,id:4397,x:32660,y:32948,varname:node_4397,prsc:2|A-5652-R,B-5652-G,C-5652-B;n:type:ShaderForge.SFN_Divide,id:8210,x:32852,y:32986,varname:node_8210,prsc:2|A-4397-OUT,B-6954-OUT;n:type:ShaderForge.SFN_Vector1,id:6954,x:32643,y:33055,varname:node_6954,prsc:2,v1:3;n:type:ShaderForge.SFN_ViewVector,id:7486,x:32921,y:33168,varname:node_7486,prsc:2;n:type:ShaderForge.SFN_LightVector,id:6491,x:32932,y:33291,varname:node_6491,prsc:2;n:type:ShaderForge.SFN_Cross,id:7789,x:33407,y:33005,varname:node_7789,prsc:2|A-7486-OUT,B-6491-OUT;n:type:ShaderForge.SFN_Dot,id:8686,x:33407,y:33173,varname:node_8686,prsc:2,dt:0|A-7486-OUT,B-6491-OUT;n:type:ShaderForge.SFN_OneMinus,id:8225,x:33614,y:33199,varname:node_8225,prsc:2|IN-8686-OUT;n:type:ShaderForge.SFN_Multiply,id:3636,x:33825,y:33034,varname:node_3636,prsc:2|A-2025-OUT,B-8225-OUT;n:type:ShaderForge.SFN_LightColor,id:18,x:33785,y:33329,varname:node_18,prsc:2;n:type:ShaderForge.SFN_Multiply,id:3268,x:33993,y:33153,varname:node_3268,prsc:2|A-3636-OUT,B-18-RGB;n:type:ShaderForge.SFN_Multiply,id:7194,x:34264,y:32994,varname:node_7194,prsc:2|A-6416-RGB,B-3268-OUT;n:type:ShaderForge.SFN_Slider,id:3397,x:34079,y:33726,ptovrint:False,ptlb:Motion,ptin:_Motion,varname:node_3397,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-3,cur:0.1325256,max:3;n:type:ShaderForge.SFN_NormalVector,id:6320,x:34692,y:33243,prsc:2,pt:False;n:type:ShaderForge.SFN_Multiply,id:3097,x:34950,y:33303,varname:node_3097,prsc:2|A-6320-OUT,B-6145-OUT;n:type:ShaderForge.SFN_Time,id:1387,x:33669,y:33492,varname:node_1387,prsc:2;n:type:ShaderForge.SFN_Sin,id:9417,x:34116,y:33512,varname:node_9417,prsc:2|IN-5114-OUT;n:type:ShaderForge.SFN_Multiply,id:8379,x:34566,y:33539,varname:node_8379,prsc:2|A-9417-OUT,B-3397-OUT;n:type:ShaderForge.SFN_Add,id:5114,x:34001,y:33548,varname:node_5114,prsc:2|A-2375-OUT,B-6649-OUT;n:type:ShaderForge.SFN_FragmentPosition,id:8953,x:33589,y:33657,varname:node_8953,prsc:2;n:type:ShaderForge.SFN_Add,id:6649,x:33779,y:33657,varname:node_6649,prsc:2|A-8953-X,B-8953-Z;n:type:ShaderForge.SFN_Multiply,id:6802,x:34681,y:33081,varname:node_6802,prsc:2|A-7194-OUT,B-2800-OUT;n:type:ShaderForge.SFN_Multiply,id:2800,x:34420,y:33235,varname:node_2800,prsc:2|A-1588-OUT,B-1054-OUT;n:type:ShaderForge.SFN_Vector1,id:1054,x:34231,y:33332,varname:node_1054,prsc:2,v1:0.2;n:type:ShaderForge.SFN_Tex2d,id:8557,x:34236,y:33832,ptovrint:False,ptlb:MotionPower,ptin:_MotionPower,varname:node_8557,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-3232-OUT;n:type:ShaderForge.SFN_Multiply,id:6145,x:34736,y:33610,varname:node_6145,prsc:2|A-8379-OUT,B-8557-R,C-8557-G,D-8557-B;n:type:ShaderForge.SFN_Slider,id:93,x:33382,y:33434,ptovrint:False,ptlb:Motion_Speed,ptin:_Motion_Speed,varname:node_93,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:10;n:type:ShaderForge.SFN_Multiply,id:2375,x:33870,y:33451,varname:node_2375,prsc:2|A-93-OUT,B-1387-T;n:type:ShaderForge.SFN_LightAttenuation,id:1588,x:34175,y:33200,varname:node_1588,prsc:2;proporder:6416-5652-555-7470-5953-9352-3739-7726-2025-3397-8557-93;pass:END;sub:END;*/
